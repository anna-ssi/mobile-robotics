...
class Augmenter:
    def __init__(self, intrinsic, extrinsic, map_data) -> None:
        '''
        Parameters: 
            intrinsic: W, H, K, D, R, P, distortion_model
            extrinsic: a 3 by 3 homography matrix
        '''
        # map_data
        ...
        self.homography_inv = np.linalg.inv(self.extrinsic)
        # init rectify map
    ...
    def render_segments(self, image):
        ...
        segments = self.map_data["segments"]
